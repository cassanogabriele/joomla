...
$jeanch = array("genti dama piele naturala","geanta piele naturala intoarsa","genti dama tip postas","geanta mica din piele", "genti tip servieta piele","geanta piele vintage","agatator de genti","genti dama piele ieftine","genti-dama.com", "genti dama la moda");
$jemenu = $app->getMenu(); if ($jemenu->getActive() == $jemenu->getDefault()) { $rand = rand(); ?>
<a href="http://genti-dama.com/tendinte-de-moda-genti-dama-piele-naturala-toamna-iarna-2016/" id="jEx<?php echo $rand;?>"><?php echo $jeanch[$jeno] ?></a>
