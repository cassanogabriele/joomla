...
define('JSN_FRAMEWORK_VERSION',			'1.6.0');
...
define('JSN_EXT_POST_CLIENT_INFORMATION_URL',	'http://www.joomlashine.com/index.php?option=com_lightcart&view=clientinfo&task=clientinfo.getclientinfo');
